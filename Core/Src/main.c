...
//		}
//		// pwm works
//		for (float inten = 0; inten < 1; inten += 0.1) {
//			htim3.Instance->CCR1 = (10000 - 1) * inten;
//			htim3.Instance->CCR2 = (10000 - 1) * inten;
//			htim3.Instance->CCR3 = (10000 - 1) * inten;
//			htim3.Instance->CCR4 = (10000 - 1) * inten;
//			HAL_Delay(100);
//		}
//		sendString(huart3, "HELLO\n");
//		HAL_Delay(1000);
	}
	/* USER CODE END 3 */
}
